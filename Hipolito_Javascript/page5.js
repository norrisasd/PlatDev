...
function clicked(){
    ...
    div.innerHTML = div.innerHTML + "<div style='width:25%;text-align:justify;font-family:arial; padding:25px;margin:1% 7% 1%;border-radius:50px 20px; background-color:#121212;color:white;word-wrap:break-word;'>" + msg.value+ "</div>";
    if(m.toLowerCase() === "hello" || m.toLowerCase() === "hi"){
        var i="Good Day!, How are you doing ?"
